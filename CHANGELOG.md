...
- Added workspace-scoped turn bookmarks with per-turn toggle controls, a keyboard-accessible bookmark list, focused navigation, reload persistence, and stale-turn filtering.
