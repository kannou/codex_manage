...
- Shows a compact summary in the Runtime trigger with the GPT version and variant, effective reasoning, Standard or Fast speed, and non-standard sandbox permissions.
